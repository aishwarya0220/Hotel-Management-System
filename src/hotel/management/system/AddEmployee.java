...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee(){
        ...
        String str[] = {"Housekeeping","Chef","Room Service","Manager","Waiter/Waitress","Driver"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String str = "insert into employee value('"+name+"','"+age+"','"+gender+"','"+job+"','"+salary+"','"+phone+"','"+aadhar+"','"+email+"')";
